...
function analyzerRenderTrafficAhead(followed){
 ...
 traffic.forEach(item=>{
  ...
  node.title=`${item.driver.driver} · ${sign}${Math.abs(item.gap).toFixed(3)} s`;
