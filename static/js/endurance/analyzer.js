...
// Velocity V7.2.92 — TEAM MANAGEMENT + Session Course persistante
...
async function velocityInviteBootstrap(){
  ...
  try{
    ...
    document.getElementById('velocityInviteText').innerHTML=`Vous rejoignez <b>${analyzerEscape(i.team_name)}</b>.`;
