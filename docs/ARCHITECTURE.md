# Architecture KartIQ V5.3.0

## Objectif

La V5.3.0 introduit une organisation JavaScript par domaines fonctionnels, sans modification volontaire du comportement, des calculs ni de l’interface.
