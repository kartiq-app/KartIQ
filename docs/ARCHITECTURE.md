# Architecture KartIQ V5.2.1

## Objectif

La V5.2.1 introduit une organisation JavaScript par domaines fonctionnels, sans modification volontaire du comportement, des calculs ni de l’interface.
